...
import 'package:fms_flutter/chewie/chewie_player.dart';
import 'package:fms_flutter/chewie/cupertino_controls.dart';
import 'package:fms_flutter/chewie/material_controls.dart';
...
class PlayerWithControls extends StatelessWidget {
      ...
      child: Container(
        ...
        child: AspectRatio(
          ...
          child: _buildPlayerWithControls(
              chewieController, context, hideBackArrow),
        ),
      ),
    );
  }
  ...
  Container _buildPlayerWithControls(ChewieController chewieController,
      BuildContext context, bool hideBackArrow) {
    return Container(
      child: Stack(
        children: <Widget>[
